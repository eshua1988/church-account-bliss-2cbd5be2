...
export const translations = {
  ...
  appSubtitle: {
    pl: 'ZBÓR BIBLIJNYCH CHRZEŚCIJAN W WARSZAWIE',
  ...
  linkNameOptional: { pl: 'Nazwa linku (opcjonalna)', ru: 'Название ссылки (необязательно)', en: 'Link name (optional)', uk: 'Назва посилання (необов’язково)' },
  formType: { pl: 'Typ formularza:', ru: 'Тип формы:', en: 'Form type:', uk: 'Тип форми:' },
  standardForm: { pl: 'Standardowy', ru: 'Стандартный', en: 'Standard', uk: 'Стандартний' },
  stepwiseForm: { pl: 'Krok po kroku', ru: 'Пошаговый', en: 'Step by step', uk: 'Покроковий' },
  standardFormHint: { pl: 'Użytkownik wypełnia wszystkie pola na jednym ekranie', ru: 'Пользователь заполняет все поля на одном экране', en: 'The user completes all fields on one screen', uk: 'Користувач заповнює всі поля на одному екрані' },
  stepwiseFormHint: { pl: 'Użytkownik wypełnia formularz krok po kroku z możliwością zapisania i pobrania PDF', ru: 'Пользователь заполняет форму пошагово с возможностью сохранить и скачать PDF', en: 'The user completes the form step by step and can save and download the PDF', uk: 'Користувач заповнює форму покроково з можливістю зберегти й завантажити PDF' },
  noSharedLinks: { pl: 'Brak utworzonych linków. Utwórz pierwszy link powyżej.', ru: 'Ссылок пока нет. Создайте первую ссылку выше.', en: 'No links yet. Create the first link above.', uk: 'Посилань поки немає. Створіть перше посилання вище.' },
  unnamedLink: { pl: 'Link bez nazwy', ru: 'Ссылка без названия', en: 'Unnamed link', uk: 'Посилання без назви' },
  copyLink: { pl: 'Kopiuj link', ru: 'Копировать ссылку', en: 'Copy link', uk: 'Копіювати посилання' },
  showQrCode: { pl: 'Pokaż kod QR', ru: 'Показать QR-код', en: 'Show QR code', uk: 'Показати QR-код' },
  openNewTab: { pl: 'Otwórz w nowej karcie', ru: 'Открыть в новой вкладке', en: 'Open in a new tab', uk: 'Відкрити в новій вкладці' },
  deleteLink: { pl: 'Usuń link', ru: 'Удалить ссылку', en: 'Delete link', uk: 'Видалити посилання' },
  qrCode: { pl: 'Kod QR', ru: 'QR-код', en: 'QR code', uk: 'QR-код' },
  linkCreated: { pl: 'Link utworzony', ru: 'Ссылка создана', en: 'Link created', uk: 'Посилання створено' },
  error: { pl: 'Błąd', ru: 'Ошибка', en: 'Error', uk: 'Помилка' },
  linkCreateError: { pl: 'Nie udało się utworzyć linku', ru: 'Не удалось создать ссылку', en: 'Could not create the link', uk: 'Не вдалося створити посилання' },
  linkDeleted: { pl: 'Link usunięty', ru: 'Ссылка удалена', en: 'Link deleted', uk: 'Посилання видалено' },
  linkCopied: { pl: 'Link skopiowano do schowka', ru: 'Ссылка скопирована в буфер обмена', en: 'Link copied to clipboard', uk: 'Посилання скопійовано в буфер обміну' },
} as const;
